...
class SettingSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Setting::create(['display_name' => 'Site Title', 'key' => 'site_title', 'value' => 'Shoppies', 'type' => 'text', 'section' => 'General']);
        Setting::create(['display_name' => 'Site Slogan', 'key' => 'site_slogan', 'value' => 'All you need is here!', 'type' => 'text', 'section' => 'General']);
        ...
        Setting::create(['display_name' => 'Facebook ID', 'key' => 'facebook_id', 'value' => 'https://www.facebook.com/Aalhbbash', 'type' => 'text', 'section' => 'Social account']);
        Setting::create(['display_name' => 'Instagram ID', 'key' => 'instagram_id', 'value' => 'https://www.instagram.com/Aalhbbash', 'type' => 'text', 'section' => 'Social account']);
    }
}
