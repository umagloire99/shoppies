                ...
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            ...
                            <input class="form-control" id="name" type="text" name="name" value="{{ old('first_name', auth()->user()->name) }}">
                ...
                <div class="row">
                    <div class="col-12">
                        @if(auth()->user()->user_image)
                            <img src="{{ asset('storage/images/users/' . auth()->user()->user_image) }}" alt="{{ auth()->user()->name }}" width="60" height="60">
                        @else
                            <img src="{{ asset('img/avatar.png') }}" alt="{{ auth()->user()->name }}" width="60" height="60">
                        @endif
                        <br>
