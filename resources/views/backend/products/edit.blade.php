                ...
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            ...
                            <textarea name="description[fr]" rows="3" class="form-control summernote">{!! old('description[fr]', $product->getTranslation('description', 'fr')) !!}</textarea>
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            ...
                            <textarea name="description[en]" rows="3" class="form-control summernote">{!! old('description[en]', $product->getTranslation('description', 'en')) !!}</textarea>
                            @error('description')<span class="text-danger">{{ $message }}</span>@enderror
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            ...
                            <textarea name="details[fr]" rows="3" class="form-control summernote">{!! old('details[fr]', $product->getTranslation('details', 'fr')) !!}</textarea>
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            ...
                            <textarea name="details[en]" rows="3" class="form-control summernote">{!! old('details[en]', $product->getTranslation('details', 'en')) !!}</textarea>
                            @error('details')<span class="text-danger">{{ $message }}</span>@enderror
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            ...
                            <textarea name="usages[fr]" rows="3" class="form-control summernote">{!! old('usages[fr]', $product->getTranslation('usages', 'fr')) !!}</textarea>
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            ...
                            <textarea name="usages[en]" rows="3" class="form-control summernote">{!! old('usages[en]', $product->getTranslation('usages', 'en')) !!}</textarea>
                            @error('usages')<span class="text-danger">{{ $message }}</span>@enderror
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            ...
                            <textarea name="features[fr]" rows="3" class="form-control summernote">{!! old('features[fr]', $product->getTranslation('features', 'fr')) !!}</textarea>
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            ...
                            <textarea name="features[en]" rows="3" class="form-control summernote">{!! old('features[en]', $product->getTranslation('features', 'en')) !!}</textarea>
                            @error('features')<span class="text-danger">{{ $message }}</span>@enderror
                        </div>
                    </div>
                </div>
