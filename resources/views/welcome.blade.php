    ...
    <div class="topbar d-none d-xl-block" style="background-color:#EDF1F0;">
        <div class="container container-xl d-flex justify-content-between">
            <ul class="list-inline d-flex align-items-center mb-0">
                <li class="list-inline-item mr-5"><a href="#" class="fs-14 lh-1"><i class="fab fa-twitter"></i></a></li>
                <li class="list-inline-item mr-5"><a href="#" class="fs-14 lh-1"><i class="fab fa-facebook-f"></i></a></li>
                <li class="list-inline-item mr-5"><a href="#" class="fs-14 lh-1"><i class="fab fa-instagram"></i></a></li>
                <li class="list-inline-item mr-5"><a href="#" class="fs-14 lh-1"><i class="fab fa-youtube"></i></a></li>
            </ul>
            <p class="mb-0 fs-13 font-weight-bold text-primary letter-spacing-01 text-uppercase">Free shipping on all U.S. orders $50+</p>
            <div class ="d-flex">
                <div class="dropdown">
                    <button class="btn btn-link dropdown-toggle text-uppercase fs-13 letter-spacing-01 py-0" type="button" id="dropdown-english" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        english
                    </button>
                ...
                <div class="dropdown">
                    <button class="btn btn-link dropdown-toggle text-uppercase fs-13 letter-spacing-01 p-0" type="button" id="dropdown-usd" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        USd
                    </button>
                    ...
                    <div class="d-flex align-items-center flex-nowrap">
                        <div class="w-50 d-flex align-items-center">
                            <a href="#search-popup" data-gtf-mfp="true"
                               ...
                               class="nav-search d-flex align-items-center pr-3 mr-auto">
                                ...
                                <span class="d-none d-xl-inline-block ml-2 text-body">Search</span>
                            </a>
                            <ul class="navbar-nav hover-menu main-menu px-0 mx-xl-n5">
                                <li aria-haspopup="true" aria-expanded="false"
                                    class="nav-item dropdown-item-home dropdown py-2 py-xl-7 px-0 px-xl-5">
                                ...
                                <li aria-haspopup="true" aria-expanded="false"
                                    class="nav-item dropdown-item-shop dropdown py-2 py-xl-7 px-0 px-xl-5">
                                    <a class="nav-link dropdown-toggle p-0"
                                ...
                                <li aria-haspopup="true" aria-expanded="false"
                                    class="nav-item dropdown-item-pages dropdown py-2 py-xl-7 px-0 px-xl-5">
                                    <a class="nav-link dropdown-toggle p-0"
                                    ...
                                    <ul class="dropdown-menu pt-3 pb-0 pb-xl-3 x-animated x-fadeInUp">
                                        ...
                                        <li class="dropdown-item dropdown dropright">
                                            ...
                                            >
                                                <li class="dropdown-item">
                                                    <a class="dropdown-link" href="contact-us-01.html">Contact Us 01</a>
                                                </li>
                                                <li class="dropdown-item">
                                                    <a class="dropdown-link" href="contact-us-02.html">Contact Us 02</a>
                                                </li>
                                            </ul>
                                        </li>
                                        <li class="dropdown-item">
                        ...
                        <div class="mx-auto flex-shrink-0 position-static">
                            <div class="d-flex mt-3 mt-xl-0 align-items-center w-100 justify-content-center">
                                <a class="navbar-brand mx-4 mx-xxl-10 d-none d-xl-inline-block"
                                   href="index.html">
                        ...
                        <div class="w-50 d-flex align-items-center justify-content-between">
                            <ul class="navbar-nav hover-menu main-menu px-0 mx-xl-n5">
                                <li aria-haspopup="true" aria-expanded="false"
                                    class="nav-item dropdown py-2 py-xl-7 px-0 px-xl-5">
                                    <a class="nav-link dropdown-toggle p-0"
                                       href="#" data-toggle="dropdown" >
                                        Blog
                                        <span class="caret"></span>
                                    ...
                                    <ul class="dropdown-menu pt-3 pb-0 pb-xl-3 x-animated x-fadeInUp">
                                        <li class="dropdown-item dropdown dropright">
                                            ...
                                            >
                                                ...
                                                <li class="dropdown-item">
                                                    <a class="dropdown-link" href="blog-grid-sidebar.html">Blog Grid Sidebar</a>
                                                </li>
                                                <li class="dropdown-item">
                                                    <a class="dropdown-link" href="blog-masonry.html">Blog Masonsy</a>
                                                </li>
                                                <li class="dropdown-item">
                                        ...
                                        <li class="dropdown-item dropdown dropright">
                                            ...
                                            >
                                                <li class="dropdown-item">
                                                    <a class="dropdown-link" href="blog-detail-01.html">Blog Detail 01</a>
                                                </li>
                                                <li class="dropdown-item">
                                                    <a class="dropdown-link" href="blog-detail-02.html">Blog Detail 02</a>
                                                </li>
                                            </ul>
                                        </li>
                                    </ul>
    ...
    <section class="mx-0 slick-slider dots-inner-center custom-slider-02 slider"
        ...
        <div class="box px-0">
            <div class="bg-img-cover-center py-12 py-lg-17"
                 style="background-image: url('images/bg-slider-04.jpg');">
                <div class="container container-xl pt-7 pb-9">
                    ...
                    <a href="shop-page-04.html"
                       class="btn btn-link btn-light bg-transparent text-white border-bottom border-0 rounded-0 p-0 fs-16 font-weight-600 border-2x"
        ...
        <div class="box px-0">
            <div class="bg-img-cover-center py-12 py-lg-17"
                 style="background-image: url('images/bg-slider-05.jpg');">
                <div class="container container-xl pt-7 pb-9">
                    <div data-animate="fadeInDown">
        ...
        <div class="box px-0">
            <div class="bg-img-cover-center py-12 py-lg-17"
                 style="background-image: url('images/bg-slider-06.jpg');">
                <div class="container container-xl pt-7 pb-9">
                    <div data-animate="fadeInDown">
        ...
        <div class="container container-lg-full">
            <div class="slick-slider custom-slider-03"
                ...
                <div class="box">
                    <div class="card border-0 product" data-animate="fadeInUp">
                        <div class="position-relative">
                            <img src="images/product-07.jpg" alt="Facial cleanser">
                ...
                <div class="box">
                    <div class="card border-0 product" data-animate="fadeInUp">
                        <div class="position-relative">
                            <img src="images/product-02.jpg" alt="Bio-shroom Rejuvenating Serum">
                            <div class="card-img-overlay d-flex p-3">
                                <div>
                                </div>
                                <div class="my-auto w-100 content-change-vertical">
                ...
                <div class="box">
                    <div class="card border-0 product" data-animate="fadeInUp">
                        <div class="position-relative">
                            <img src="images/product-05.jpg" alt="Facial cleanser">
                            <div class="card-img-overlay d-flex p-3">
                                <div>
                                    <span class="badge badge-primary">-20%</span>
                                </div>
                ...
                <div class="box">
                    <div class="card border-0 product" data-animate="fadeInUp">
                        <div class="position-relative">
                            <img src="images/product-04.jpg" alt="Coffee Bean Caffeine Eye Cream">
                            <div class="card-img-overlay d-flex p-3">
                                <div>
                                    <span class="badge badge-primary">-20%</span>
                                </div>
        ...
        <div class="container container-xl">
            <div class="row align-items-end">
                <div class="col-lg-4 order-2 order-lg-1 pb-11 pt-8 py-lg-13 py-xl-17">
                    ...
                    <a href="shop-page-04.html"
                       class="btn btn-white rounded text-secondary border-0 shadow-1 bg-hover-secondary hover-white">Explore
                        More</a>
                </div>
                <div class="col-lg-8 order-1 order-lg-2">
                    <img src="images/bg-other-02.png" alt="Countdown-01" data-animate="fadeIn">
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6">
                    <div class="card border-0 mb-lg-0 mb-6" data-animate="fadeInUp">
                        <a href="#" class="hover-zoom-in hover-shine"><img src="images/categories-01.jpg" alt="Bodycare"></a>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="card border-0 mb-lg-0 mb-6" data-animate="fadeInUp">
                        <a href="#" class="hover-zoom-in hover-shine"><img src="images/categories-02.jpg" alt="Skincare"></a>
                        <div class="card-body text-center">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="card border-0 mb-lg-0 mb-6" data-animate="fadeInUp">
                        <a href="#" class="hover-zoom-in hover-shine"><img src="images/categories-03.jpg" alt="Accessories"></a>
                        <div class="card-body text-center">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="card border-0 mb-lg-0 mb-6" data-animate="fadeInUp">
                        <a href="#" class="hover-zoom-in hover-shine"><img src="images/categories-04.jpg" alt="Haircare"></a>
                        <div class="card-body text-center">
        ...
        <div class="container container-xl">
            <div class="row align-items-center">
                <div class="col-lg-7" data-animate="fadeIn">
                    <img src="images/Countdown-01.png" alt="Countdown-01">
                ...
                <div class="col-lg-5 py-lg-0 py-9" data-animate="fadeInUp">
                    ...
                    <div class="countdown d-flex mb-7 mx-n2 mx-sm-n4" data-countdown="true"
                         data-countdown-end="Jan 27, 2023 18:24:25">
    ...
    <section class="py-lg-13 pb-11 pt-10">
        <div class="container container-xl text-center">
            ...
            <div class="slick-slider"
                 data-slick-options='{"slidesToShow": 3,"arrows":false,"dots":false,"responsive":[{"breakpoint": 992,"settings": {"slidesToShow":2,"dots":true}},{"breakpoint": 768,"settings": {"slidesToShow": 1,"dots":true}}]}'>
                <div class="box">
                    <div class="card border-0" data-animate="fadeInUp">
                        <a href="blog-detail-01.html" class="hover-shine card-img-top">
                            <img src="images/post-01.jpg"
        ...
        <div class="container text-center">
            ...
            <form class="mx-auto" style="max-width: 546px">
                <div class="input-group position-relative mb-6" data-animate="fadeInUp">
                    <input type="email" class="border-0 form-control bg-white"
                    ...
                    <div class="slick-slider mx-n2"
                        ...
                        <div class="box px-2">
                            <a href="#" class="hover-zoom-in hover-shine d-block" data-animate="fadeInUp">
                                <img src="images/instagram-01.jpg" alt="Instagram 01">
                            </a>
                        </div>
                        <div class="box px-2">
                            <a href="#" class="hover-zoom-in hover-shine d-block" data-animate="fadeInUp">
                                <img src="images/instagram-02.jpg" alt="Instagram 02">
                            </a>
                        </div>
                        <div class="box px-2">
                            <a href="#" class="hover-zoom-in hover-shine d-block" data-animate="fadeInUp">
                                <img src="images/instagram-03.jpg" alt="Instagram 03">
                            </a>
                        </div>
                        <div class="box px-2">
                            <a href="#" class="hover-zoom-in hover-shine d-block" data-animate="fadeInUp">
                                <img src="images/instagram-04.jpg" alt="Instagram 04">
                            </a>
                        </div>
                        <div class="box px-2">
                            <a href="#" class="hover-zoom-in hover-shine d-block" data-animate="fadeInUp">
                                <img src="images/instagram-05.jpg" alt="Instagram 05">
                            </a>
                        </div>
                    </div>
                </div>
    ...
    <div class="container container-xl">
        <div class="row">
            <div class="col-lg-5 col-12 mb-7 mb-lg-0">
                <h3 class="mb-3">Care for Your Skin,<br>
                    Care for Your Beauty</h3>
                <p class="lh-16 pr-xl-17 mb-lg-7">Smile with the reflection of the glow. Let your Skin define your age and not the years</p>
                <a class="font-weight-600 fs-16 text-decoration-none" href="#">Find a store <i class="ml-2 fal fa-long-arrow-right"></i></a>
            </div>
            <div class="col-lg col-md-4 col-12 mb-7 mb-lg-0">
                <h3 class="fs-20 mb-3">Company</h3>
                <ul class="list-unstyled mb-0">
                    <li class="pb-1"><a href="#" class="text-body lh-175">About us</a></li>
                    <li class="py-1"><a href="#" class="text-body lh-175">Careers</a></li>
                    <li class="py-1"><a href="#" class="text-body lh-175">Store Locations</a></li>
                    <li class="py-1"><a href="#" class="text-body lh-175">Our Blog</a></li>
                    <li class="pt-1"><a href="#" class="text-body lh-175">Reviews</a></li>
                </ul>
            </div>
            <div class="col-lg col-md-4  col-12 mb-7 mb-lg-0">
        ...
        <div class="row mt-0 mt-lg-16 align-items-center">
            ...
            <div class="col-12 col-lg-4 text-md-center order-1 order-lg-2">
                <img src="images/logo-black-x1.png" alt="Glowing">
            </div>
